...
from app.core.security import verify_password, get_password_hash, create_access_token, truncate_password
...
async def register(user_data: UserCreate, db: AsyncSession = Depends(get_db)):
    try:
        ...
        user_data.password = truncate_password(original_password)
        print(f"Password after truncation: {len(user_data.password)} chars")
